...
public class CardTemplate {
    ...
    String renderFront(CardReference cardReference, ArrayList<String> fields) {
        return generateImagesAndUpdatePath(substituteFields(fields, cardReference.getFields(), frontTemplate));
    }
    ...
    String renderRear(CardReference cardReference, ArrayList<String> fields) {
        String generatedRear = generateImagesAndUpdatePath(substituteFields(fields, cardReference.getFields(), rearTemplate));
    ...
    private String generateImagesAndUpdatePath(String template) {
        return updateImagesPath(LaTeX.convertLatexTagsToLinks(template));
    }
